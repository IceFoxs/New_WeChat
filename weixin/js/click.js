...
function address_list_click(){
	...
	found_native();
	me_native();
	$("#address_list_content").css({"visibility":"visible"});
	$("#chat_content").hide();
	$("#found_content").hide();
    $("#me_content").hide();
...
function found_click(){
    ...
    $("#me_content").hide();
	$("#address_list_content").hide();
	$("#found_content").css({"visibility":"visible"});
	$("#found_content").show();
}
function me_click(){
	add_leave();
	...
	$("#address_list_content").hide();
	$("#found_content").hide();
	$("#me_content").css({"visibility":"visible"});
	$("#me_content").show();
}
...
function wallet_click(){
    ...
    $("#mywallet").css({"z-index":3});
}
function mywallet_return(){
	 $("#top_wallet").css({
	 "height":"50px",
	 "width": "100%",
	  "top":"22px",
